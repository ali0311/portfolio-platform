...
export const hobbies = [
  {
    title: "Adapting New Tech",
    description: "Keen on adopting new technologies to solve complex business problems with practical, modern solutions.",
    icon: "Sparkles",
  },
  {
    title: "Video Editing",
    description: "Telling visual stories using tools like VN Editor and iMovie — a creative outlet outside engineering.",
    icon: "Video",
  },
  {
    title: "Badminton & Gym",
    description: "Regular badminton matches and disciplined gym training keep me sharp, energized, and ready to focus.",
    icon: "Dumbbell",
  },
];
